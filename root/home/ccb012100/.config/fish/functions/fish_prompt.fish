...
or set -g __fish_git_prompt_show_informative_status
set -q __fish_git_prompt_showcolorhints
or set -g __fish_git_prompt_showcolorhints
set -q __fish_git_prompt_showupstream informative
...
or set -g __fish_git_prompt_char_upstream_ahead '+'
set -q __fish_git_prompt_char_upstream_behind
or set -g __fish_git_prompt_char_upstream_behind -
set -q __fish_git_prompt_char_upstream_diverged
or set -g __fish_git_prompt_char_upstream_diverged ' 🚧  '
